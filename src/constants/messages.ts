export const messages = {
    please_connect: "Please connect your wallet to the Avalanche network to use Arsenal NFT.",
    please_connect_wallet: "Please connect your wallet.",
    try_mint_more: (value: string) => `You're trying to bond more than the maximum payout available! The maximum bond payout is ${value} ANFT.`,
