...
function ChooseBond() {
    ...
    const anftToBond = useSelector<IReduxState, number>(state => {
        return state.app.anftToBond
    });
    ...
    const poolValue = useSelector<IReduxState,number>( state => {
        return state.app.poolValue;
    });
                    ...
                    <Grid container item xs={12} spacing={2} className="choose-bond-view-card-metrics">
                        <Grid item xs={12} sm={4}>
                            <Box textAlign="center">
                                <p className="choose-bond-view-card-metrics-title">MarketCap</p>
                        ...
                        <Grid item xs={12} sm={4}>
                            <Box textAlign="center">
                                <p className="choose-bond-view-card-metrics-title">WarChest Balance</p>
                                <p className="choose-bond-view-card-metrics-value">
                                    {isAppLoading ? (
                        ...
                        <Grid item xs={12} sm={4}>
                            <Box textAlign="center">
                                <p className="choose-bond-view-card-metrics-title">Pool Value</p>
                                <p className="choose-bond-view-card-metrics-value">
                                    {isAppLoading ? <Skeleton width="100px" /> : 
                                    `$${trim(poolValue, 2)}`}
                                </p>
                        ...
                        <Grid item xs={12} sm={4}>
                            <Box textAlign="center">
                                <p className="choose-bond-view-card-metrics-title">ANFT Price</p>
                                <p className="choose-bond-view-card-metrics-value">
                                    {isAppLoading ? <Skeleton width="100px" /> : 
                                    `$${trim(marketPrice, 2)}`}
                                </p>
                        ...
                        <Grid item xs={12} sm={4}>
                            <Box textAlign="center">
                                <p className="choose-bond-view-card-metrics-title">Bondable ANFT</p>
                                <p className="choose-bond-view-card-metrics-value">
                                    {isAppLoading ? <Skeleton width="100px" /> : 
                                    `${trim(anftToBond, 2)}`}                              
                                </p>
                        ...
                        <Grid item xs={12} sm={4}>
                            <Box textAlign="center">
                                <p className="choose-bond-view-card-metrics-title">Backed Liquidity</p>
                                <p className="choose-bond-view-card-metrics-value">
                                    100%
                                </p>
                            </Box>
